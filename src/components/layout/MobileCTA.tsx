  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[80] bg-white/90 backdrop-blur-xl border-t border-neutral-100 p-4 md:hidden safe-area-inset-bottom shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
      <Button
        ...
        className="w-full h-14 rounded-xl font-bold text-sm uppercase tracking-wider shadow-lg shadow-brand-blue/20 bg-brand-blue hover:bg-blue-900 text-white flex items-center justify-center gap-2"
      >
