...
export const trips: ReadonlyArray<Trip> = [
  ...
  },
  {
    ...
    imageBadge: {
      text: "Marine Park ticket required",
      tone: "warning",
    },
    galleryImages: [
